...
function eduker_breadcrumb_bottom_spacing() {
    $padding_px = get_theme_mod( 'eduker_breadcrumb_bottom_spacing', '160px' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $padding_px != '' ) {
        $custom_css = '';
        $custom_css .= ".breadcrumb-spacing{ padding-bottom: " . $padding_px . "}";

        wp_add_inline_style( 'eduker-breadcrumb-bottom-spacing', $custom_css );
    }
}
add_action( 'wp_enqueue_scripts', 'eduker_breadcrumb_bottom_spacing' );

// scrollup
function eduker_scrollup_switch() {
    $scrollup_switch = get_theme_mod( 'eduker_scrollup_switch', false );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $scrollup_switch ) {
        $custom_css = '';
        $custom_css .= "#scrollUp{ display: none !important;}";

        wp_add_inline_style( 'eduker-scrollup-switch', $custom_css );
    }
}
add_action( 'wp_enqueue_scripts', 'eduker_scrollup_switch' );

// theme color
function eduker_custom_color() {
    $color_code = get_theme_mod( 'eduker_color_option', '#2b4eff' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $color_code != '' ) {
        $custom_css = '';
...
// theme color
function eduker_custom_color_primary() {
    $color_code = get_theme_mod( 'eduker_color_option_2', '#f2277e' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $color_code != '' ) {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action( 'wp_enqueue_scripts', 'eduker_custom_color_primary' );

// theme color
function eduker_custom_color_scrollup() {
    $color_code = get_theme_mod( 'eduker_color_scrollup', '#2b4eff' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $color_code != '' ) {
        $custom_css = '';
        $custom_css .= ".demo-class { color: " . $color_code . "}";
...
add_action( 'wp_enqueue_scripts', 'eduker_custom_color_scrollup' );

// theme color
function eduker_custom_color_secondary() {
    $color_code = get_theme_mod( 'eduker_color_option_3', '#30a820' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $color_code != '' ) {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action( 'wp_enqueue_scripts', 'eduker_custom_color_secondary' );

// theme color
function eduker_custom_color_secondary_2() {
    $color_code = get_theme_mod( 'eduker_color_option_3_2', '#ffb352' );
    wp_enqueue_style( 'eduker-custom', EDUKER_THEME_CSS_DIR . 'eduker-custom.css', [] );
    if ( $color_code != '' ) {
        $custom_css = '';
        $custom_css .= ".demo-class { background-color: " . $color_code . "}";
...
add_action( 'wp_enqueue_scripts', 'eduker_custom_color_secondary_2' );
